...
<body>
    ...
    <?php
		if($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			if($manCount == 1){
				...
				echo "<div class='error-center'>Username or Password is invalid.</div>";
			}	
		}
    ?>
    ...
    <form action="" method="post">
		...
		<div class="btn-posit">
			<form>
			<input type="button" onclick="location.href='http://localhost:1234/listenerhomepage.php';" value="I'm a Listener" />
			</form>
		</div>
		
		<div class="btn-posit">
			<form>
			<input type="button" onclick="location.href='http://localhost:1234/advertiserhomepage.php';" value="I'm an Advertiser" />
			</form>		
		</div>
